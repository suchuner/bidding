...
<head id="Head1">
	...
	<script type="text/javascript" src='${pageContext.request.contextPath}/bidding-js/index.js'> </script>
    <script type="text/javascript">
        $(function(){
            $.ajax({
                url:'user_getLoginUserByLoginToken.action',
                type:'post',
                success:function(info){
                    if(!eval('('+info+')').flag){
                        window.location.href="/website/logoo.jsp";
                        return;
                    }
                    $('#username').text(eval('('+info+')').retMessage.username);
                }
            });
        });
    </script>
...
<div id="pageloading" style="position:absolute; top:50%; left:50%; margin:-120px 0px 0px -120px; text-align:center;  border:2px solid #8DB2E3; width:200px; height:40px;  font-size:14px;padding:10px; font-weight:bold; background:#fff; color:#15428B;"> 
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="float:right; padding-right:20px;" class="head">欢迎: <span id="username"></span>  <a href="#" id="editpass">修改密码</a> <a href="#" id="user_loginOut">安全退出</a></span>
        <span style="padding-left:10px; font-size: 16px; "><img src="${pageContext.request.contextPath}/images/blocks.gif" width="20" height="20" align="absmiddle" /> 招标管理系统</span>
    </div>
