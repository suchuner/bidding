			...
			[
			 	{
					...
					[
						{"icon":"icon-sys","menuid":"101","menuname":"供应商注册审核","url":"http://localhost:8090/supplier_toDoSupplierCheck.action"}	,
						{"icon":"icon-sys","menuid":"102","menuname":"招标项目申请","url":"http://localhost:8080/project/toProjectPage/0.do"},
						{"icon":"icon-sys","menuid":"103","menuname":"审核招标项目申请","url":"http://localhost:8080/project/toProjectPage/1.do"},
...
$(function(){
	...
	tabClose();
	tabCloseEven();
	$('#user_loginOut').bind('click',function(){
		$.ajax({
