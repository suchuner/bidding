			...
			[
			 	{
					...
					[
						{"icon":"icon-sys","menuid":"101","menuname":"我的评标项目","url":"http://localhost:8080/projectExpert/toMyBiddingPage.do"}
					]
			 	}
			 ]
		};
...
$(function(){	
	...
	tabClose();
	tabCloseEven();
    $('#expert_loginOut').bind('click',function(){
        $.ajax({
            url:'expert_logout.action',
            success:function(){
