        ...
        var columns = [[
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    }else if(row.project.status*1===5){
                        if(row.iswinner*1===1) return '是否中标:<em style="color: red;font-size: 16px">中标</em>';
                    ...
                    $('#biddingForm').ajaxSubmit(function (info) {
                        $.messager.alert('提示', eval('(' + info + ')').retMessage, 'info',function(){
                            if(eval('(' + info + ')').flag){
                                ...
                                $('#grid_select_mybidding_is_begin_yes').datagrid('reload');
                            }
                        });
                    });
                }
...
<body>
<table id="grid_select_mybidding_is_begin_yes"></table>
<div id='biddingDlg'>
